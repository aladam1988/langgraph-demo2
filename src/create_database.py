...
def create_database():
    ...
    # 连接到数据库
    conn = sqlite3.connect("data/account_data.db")
    cursor = conn.cursor()
    ...
    CREATE TABLE IF NOT EXISTS meter_readings (
        ...
        daily_max REAL,
        daily_min REAL,
        PRIMARY KEY (account_id, reading_time)
    )
    """)
    
    # 准备数据
    data = """account_id	reading_time	current_reading	current_usage	average_usage	daily_average	daily_max	daily_min
...
10	2025/4/1	421	11	3.5	11	11	11"""
    ...
    for line in lines[1:]:
        ...
        (account_id, reading_time, current_reading, current_usage, average_usage, 
         daily_average, daily_max, daily_min)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        """, fields)
